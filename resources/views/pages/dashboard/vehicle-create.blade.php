                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.vehicle.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="vin-number" type="text" class="form-control @error('vin-number') is-invalid @enderror" name="vin_number" value="{{ old('vin-number') }}" required autocomplete="vin-number" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="number_plates" type="text" class="form-control @error('number_plates') is-invalid @enderror" name="number_plates" value="{{ old('number_plates') }}" required autocomplete="number_plates">
