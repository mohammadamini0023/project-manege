        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.service.update', ['service_id' => $service->id]) }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="miles" type="text" class="form-control @error('miles') is-invalid @enderror" name="miles" value="{{ old('miles', $service->miles) }}" required autocomplete="miles" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price', $service->price) }}" required autocomplete="price">
